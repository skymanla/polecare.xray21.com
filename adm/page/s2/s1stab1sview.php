...
$sql = "select * from $tbl where chartnum='".$id."' and status='퇴원' and delete_flag != 1";
$q = $db->query($sql);
						...
						<td>
							<select name="patient_bandtype" title="" class="w_input1">								
								<?php
									...
									// $sql = "select seq, equiment_name from tbl_equiment where equiment_type='손목형밴드' and delete_flag = '0' order by seq desc";
									$sql = "select seq, equiment_name, equiment_macadd 
												from tbl_equiment 
											where 
