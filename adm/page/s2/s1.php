...
$count_sql = "select count(*) as cnt from $tbl where status='입원' and delete_flag != 1 ".$searchQuery;
...
$sql = "select *, (select equiment_name from tbl_equiment where seq=patient_bandtype) as bandName from 
		$tbl where status='입원' and delete_flag != 1 $searchQuery
...
<section class="section1">
	...
	<ul class="tab_type1">
		<li class="active"><a href="s1.php">입원환자</a></li>
		<li><a href="s1stab1.php">퇴원환자</a></li>
	</ul>
	...
	<div class="table_wrap1">
		<table>
			...
			<tbody>
				<?php
					if($list_flag == false){
						echo "<tr><td class='txt_c' colspan='8'>입원중인 환자가 없습니다.</td></tr>";
					}else{
				?>
				...
				<tr>
					...
					<td class="txt_c"><a href="s1sview.php?id=<?=$row['chartnum']?>&page=<?=$cur_page?>" class="bt_s1">정보수정</a></td>
				</tr>
				<?php
					$board_no--;
					}
